...
type ordersTable struct {
	...
	ShipDate  postgres.ColumnTimestamp
	Status    postgres.ColumnString
	Complete  postgres.ColumnBool
...
func newOrdersTableImpl(schemaName, tableName, alias string) ordersTable {
	var (
		...
		ShipDateColumn  = postgres.TimestampColumn("ship_date")
		StatusColumn    = postgres.StringColumn("status")
		CompleteColumn  = postgres.BoolColumn("complete")
		CreatedAtColumn = postgres.TimestampColumn("created_at")
		allColumns      = postgres.ColumnList{IDColumn, PetIDColumn, QuantityColumn, ShipDateColumn, StatusColumn, CompleteColumn, CreatedAtColumn}
		mutableColumns  = postgres.ColumnList{PetIDColumn, QuantityColumn, ShipDateColumn, StatusColumn, CompleteColumn, CreatedAtColumn}
	)
